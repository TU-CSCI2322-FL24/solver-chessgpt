...
possibleMoves game piece@(Bishop,_,(x,y))    = 
  where moves = [(x+1,y+1),(x+2,y+2),(x+3,y+3),(x+4,y+4),(x+5,y+5),(x+6,y+6),(x+7,y+7),(x+8,y+8),(x-1,y-1),(x-2,y-2),(x-3,y-3),(x-4,y-4),(x-5,y-5),(x-6,y-6),(x-7,y-7),(x-8,y-8),(x-1,y+1),(x-2,y+2),(x-3,y+3),(x-4,y+4),(x-5,y+5),(x-6,y+6),(x-7,y+7),(x-8,y+8),(x+1,y-1),(x+2,y-2),(x+3,y-3),(x+4,y-4),(x+5,y-5),(x+6,y-6),(x+7,y-7),(x+8,y-8)]--very rough and inefficent, but it should work
